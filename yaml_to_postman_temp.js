...
//         output.write(line + '\n')
//     }
//     else if(responses_found && line.includes("example:") && line.includes("}")){
//         var toWrite = '            example: '
...
//     else if(responses_found && line.includes("example:") && line.includes("/") == false){
//         responses_found = true;
//         not_f_response = true;
//         res_example = res_example + line
//         console.log("KEEP TOTAL RESPONSE EXAMPLE")
//         console.log(res_example)
//     }

//    // found the end line of the example
//    else if(responses_found && not_f_response && line.includes("/")){
//     console.log("END OF EXAMPLE")
//     //total_example = total_example + line.trim()
//     console.log(res_example)

//     var toWrite = '            example: '
//     output.write(toWrite + eval(res_example) + '\n')
//     responses_found = false;
//     not_f_response = false;
//     res_example = ""
// }
// else if(responses_found && not_f_response){
//     res_example = res_example + line
// }

//     // REQUEST BODY
//    else 
    if (line.includes("x-codegen-request-body-name")){
